...
import { GetClientByID, GetProjectsByClientID } from "../../service/users";
import { GetCompanyById, GetProjectsByCompanyID } from "../../service/companies";
        ...
        <>
            ...
            <div>
                ...
                <Panel header="PROJECTS" toggleable className='m-3'>
                    ...
                    <DataTable paginatorTemplate={template} value={projects} emptyMessage="No projects found." rowHover selectionPageOnly selection={selectedRow} onSelectionChange={e => onRowSelect(e.value)} loading={loading} scrollable scrollHeight="400px" selectionMode="single" scrollDirection="both" className="mt-3" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} posts" rows={20} paginator>
